...
l2_leaf_reg = [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 1.5, 2, 2.5, 3, 4, 5, 6, 7, 8, 9, 10, 12, 15]

for item in l2_leaf_reg:
    print(f'>>>>>>>>>>>>>>>>>>>> {item} 시작 >>>>>>>>>>>>>>>>>>>>')
    seed = 1111
    ...
    for train_idx, val_idx in kfold.split(x_train, y_train):
        ...
        params = {'iterations': 799, 'learning_rate': 0.08634765067330821, 'depth': 9, 'l2_leaf_reg':item}
