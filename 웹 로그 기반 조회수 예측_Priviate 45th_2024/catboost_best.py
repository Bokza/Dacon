...
params = {'iterations': 799, 'learning_rate': 0.08634765067330821, 'depth': 9, 'random_strength':1.005} # , 'l2_leaf_reg':2.95
...
df_submit['TARGET'] = np.round(pred)

df_submit.head()

df_submit.to_csv(f"cat44.csv", index=False)
